...
Loop, Files, %SOLUTIONS%\*.solution
{
    ...
    LV_Add(, "", Primary(), Secondary(), Tertiary(), Supplement(), "", "", submitter, pronouns_by_submitter_timestamp[pronounskey], solution_name, A_LoopFileName, timestamp, DllCall("libverify\verifier_error", "Ptr", verifier, "AStr"))
